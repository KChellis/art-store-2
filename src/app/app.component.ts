...
export class AppComponent {
  masterArtList: Art[] = [
    ...
    new Art ('Dichroic Glass Necklaces', 'Fused Glass', ['Dichroic glass', 'Silver Findings', 'Black Satin Cord'], 25.00, 'no image yet', ['Plumage', 'Clockworks', 'Circuits', 'String Theory', 'Labyrinth'], 'Necklaceds amde with handcut dichroic glass. No two pieces are exactly alike')
  ];
}
